...
function renderMonsterInfo(monster, monsterObj) {
	...
	const monster_race_icon = `${monster.id === 10444 ? `../tos_tool_data/img/other/icon_yao.png` : monster.id === 10495 ? `../tos_tool_data/img/other/icon_kirito.png` : `../tos_tool_data/img/monster/icon_${race_zh_to_en[monster_info.race]}.png`}`
...
function renderMonsterImage(monster, tooltip_content, monsterObj, eggLink = false) {
	...
	const idString = paddingZeros(displayId, 3)
