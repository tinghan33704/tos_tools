// Last modified : 2023.03.28 13:49
...
const leader_skill_data = [
    ...
    },
    {
        ...
        'monster': [1298, 1693, 1701, 1774, 1886, 1887, 1888, 1889, 1893, 1996, 2023, 2073, 2143, 2147, 2148, 2290, 2293, 2295, 2298, 2299, 2335, 2475, 2587, 2589, 2590, 2650, 2659, 2672, 2730, 2785, 2786, 9019, 10053, 10081, 10133, 10134, 10193, 10207, 10229, 10306, 10361, 10362]
    },
    {
        'name': '絕境意志 ‧ 暗',
    ...
    },
    {
        ...
        'monster': [1725, 1892, 1991, 1992, 1993, 1994, 1995, 2090, 2478, 2625, 2628, 2715, 2716, 10109, 10151, 10209, 10232, 10258, 10283, 10364, 10380, 10411]
    },
    {
        'name': '彩虹的衝擊',
    ...
    },
    {
        ...
        'monster': [1853, 1858, 1904, 1975, 2141, 2171, 2308, 2316, 2317, 2373, 2375, 2441, 2442, 2443, 2444, 2445, 2506, 2508, 2565, 2582, 2593, 2651, 2652, 2657, 2750, 2761, 2812, 2818, 7029, 10051, 10055, 10059, 10095, 10156, 10157, 10160, 10205, 10273, 10277, 10282, 10315, 10369]
    },
    {
        'name': '龍類萬鈞之怒',
    ...
    },
    {
        ...
        'monster': [2530, 2531, 2540, 2576, 2579, 2649, 2654, 2738, 2787, 2816, 10111, 10116, 10159, 10201, 10231, 10287, 10368, 10376]
    },
    {
        'name': '使徒來襲',
    ...
    },
    {
        ...
        'monster': [2534, 2575, 2580, 2646, 2655, 2666, 2671, 2724, 2725, 2726, 2727, 2740, 2747, 2801, 2904, 10057, 10097, 10108, 10112, 10115, 10130, 10132, 10153, 10161, 10185, 10186, 10221, 10233, 10290, 10311, 10316, 10319, 10354, 10378, 10393, 10412]
    },
    {
        'name': '第二適格者 ‧ 改',
    ...
    },
    {
        ...
        'monster': [2546, 2556, 2557, 2558, 2559, 2560, 2574, 2578, 2592, 2903, 10107, 10158, 10202, 10243, 10255, 10286, 10363]
    },
    {
        'name': '沸騰魔勢',
    ...
    },
    {
        ...
        'monster': [2577, 2596, 2687, 2691, 2692, 2696, 2802, 10058, 10099, 10152, 10210, 10312, 10381]
    },
    {
        'name': '妖精萬鈞之怒 ‧ 極',
        ...
        'monster': [2581, 2597, 2737, 2817, 10060, 10098, 10164, 10208, 10215, 10234, 10239, 10305, 10355, 10356, 10357, 10358, 10379]
    },
    {
        'name': '御天之志',
    ...
    {
        'name': '浪濤之誅罰 ‧ 弒',
        'description': 'I. 水屬性成員攻擊力 7 倍、生命力及回復力 2.5 倍<br>II. 水屬性對所有目標的傷害額外 10 倍<br>III. 敵人受到的主動技能炮擊傷害額外 3.5 倍<br>IV. 所受火及暗屬性傷害減少 50%<br>V. 所有成員無視屬性相剋',
        'tag': [
            {
    ...
    {
        'name': '熾燄之誅罰 ‧ 弒',
        'description': 'I. 火屬性成員攻擊力 7 倍、生命力及回復力 2.5 倍<br>II. 火屬性對所有目標的傷害額外 10 倍<br>III. 敵人受到的主動技能炮擊傷害額外 3.5 倍<br>IV. 所受火及木屬性傷害減少 50%<br>V. 所有成員無視屬性相剋',
        'tag': [
            {
                'name': ['增攻', '增血', '增回', '對水增傷', '對火增傷', '對木增傷', '對光增傷', '對暗增傷'],
                'object': ['火'],
    ...
    {
        'name': '藤棘之誅罰 ‧ 弒',
        'description': 'I. 木屬性成員攻擊力 7 倍、生命力及回復力 2.5 倍<br>II. 木屬性對所有目標的傷害額外 10 倍<br>III. 敵人受到的主動技能炮擊傷害額外 3.5 倍<br>IV. 所受水及光屬性傷害減少 50%<br>V. 所有成員無視屬性相剋',
        'tag': [
            {
                'name': ['增攻', '增血', '增回', '對水增傷', '對火增傷', '對木增傷', '對光增傷', '對暗增傷'],
                'object': ['木'],
    ...
    {
        'name': '玄光之誅罰 ‧ 弒',
        'description': 'I. 光屬性成員攻擊力 7 倍、生命力及回復力 2.5 倍<br>II. 光屬性對所有目標的傷害額外 10 倍<br>III. 敵人受到的主動技能炮擊傷害額外 3.5 倍<br>IV. 所受火及暗屬性傷害減少 50%<br>V. 所有成員無視屬性相剋',
        'tag': [
            {
                'name': ['增攻', '增血', '增回', '對水增傷', '對火增傷', '對木增傷', '對光增傷', '對暗增傷'],
                'object': ['光'],
    ...
    {
        'name': '幽冥之誅罰 ‧ 弒',
        'description': 'I. 暗屬性成員攻擊力 7 倍、生命力及回復力 2.5 倍<br>II. 暗屬性對所有目標的傷害額外 10 倍<br>III. 敵人受到的主動技能炮擊傷害額外 3.5 倍<br>IV. 所受木及光屬性傷害減少 50%<br>V. 所有成員無視屬性相剋',
        'tag': [
            {
                'name': ['增攻', '增血', '增回', '對水增傷', '對火增傷', '對木增傷', '對光增傷', '對暗增傷'],
                'object': ['暗'],
